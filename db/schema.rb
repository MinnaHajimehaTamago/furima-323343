...
ActiveRecord::Schema.define(version: 2020_12_28_122154) do
  ...
  create_table "item_tag_releations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_item_tag_releations_on_item_id"
    t.index ["tag_id"], name: "index_item_tag_releations_on_tag_id"
  end
