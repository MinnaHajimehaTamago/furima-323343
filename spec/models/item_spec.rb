...
RSpec.describe Item, type: :model do
    ...
    #   it '必須項目が入力されていれば出品できること' do
    #     expect(@item).to be_valid
    #   end
    #   it 'category_idが1以外であれば出品できること' do
    #     @item.category_id = '2'
    #     expect(@item).to be_valid
    #   end
    #   it 'state_idが1以外であれば出品できること' do
    #     @item.state_id = '2'
    #     expect(@item).to be_valid
    #   end
    #   it 'delivery_fee_idが1以外であれば出品できること' do
    #     @item.delivery_fee_id = '2'
    #     expect(@item).to be_valid
    #   end
    #   it 'prefecture_idが1以外であれば出品できること' do
    #     @item.prefecture_id = '2'
    #     expect(@item).to be_valid
    #   end
    #   it 'days_to_ship_idが1以外であれば出品できること' do
    #     @item.days_to_ship_id = '2'
    #     expect(@item).to be_valid
    #   end
    #   it 'priceが300以上9999999以下であれば出品できること（最小値）' do
    #     @item.price = 300
    #     expect(@item).to be_valid
    #   end
    #   it 'priceが300以上9999999以下であれば出品できること（最大値）' do
    #     @item.price = 9999999
    #     expect(@item).to be_valid
    #   end
    # end
    ...
    context '商品が出品できない時' do
      ...
      it 'prefecture_idが1だと出品できなこと' do
        @item.prefecture_id = "1"
        @item.valid?
        expect(@item.errors.full_messages).to include('発送元の地域を選択してください')
      end
      it 'days_to_ship_idが1だと出品できないこと' do
